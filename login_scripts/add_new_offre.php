...
<body>
    ...
    <div class="container"> 
        <div class=" text-center mb-4">
            <h3>Add offre information</h3>  
            <p class="text-muted">add new offre informations</p>
        </div>
    </div>
...
if(isset($_POST['submit'])) {
    ...
    $model_obj->createoffer($duree_stage, $base_remuneration, $date_d_offre, $Nombre_place_offertes,$promo_concernees,$titre_offre,$desc_offre);
}
?>